...
namespace Rodes\WpWebFrameworkExampleApp\Models\Admin;

use Rodes\WpWebFrameworkExampleApp\Application;
use Rodes\WpWebFrameworkExampleApp\Includes\HooksManager;

if ( ! class_exists( 'AdminSettingsModel' ) ) {

	class AdminSettingsModel extends AdminModel {

		protected static $settings;

		const SETTINGS_NAME = Application::PLUGIN_ID;
		...
		protected function register_hook_callbacks() {
			...
			HooksManager::add_action( 'admin_init', $this, 'register_settings' );
